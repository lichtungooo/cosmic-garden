...
Mit vollem 10-Block-Steckbrief befüllt (61 von 87 Pflanzen — gut zwei Drittel):
...
- **Welle 6** (10): `heidelbeere`, `brombeere`, `himbeere`, `johannisbeere`, `stachelbeere`, `sauerkirsche`, `pflaume`, `aprikose`, `walnuss`, `haselnuss`
- **Welle 7** (10): `bohnenkraut`, `kerbel`, `koriander`, `fenchel`, `kapuzinerkresse`, `lavendel`, `mais`, `sonnenblume`, `pfefferminze`, `kamille`

Restliche 26 Pflanzen haben weiterhin nur die Pflicht-Felder + Markdown-Texte aus dem Ursprungs-Stand. Leere Steckbrief-Blöcke werden im UI ausgeblendet, kein visueller Bruch. Vorschlag für die nächsten Wellen: Spitzwegerich, Vogelmiere, Giersch, Holunder, Aronia, Quinoa, Amaranth, Einkorn, Emmer, Pastinake, Schwarzwurzel, Topinambur, Haferwurzel, Knollenziest, Erdkastanie, Brokkoli, Blumenkohl, Feldsalat, Cannabis, Weinrebe, Rose, Loewenzahn.
